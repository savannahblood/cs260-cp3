<template>
<div>
  <div class='plx' id='home-bg'>
    <div class='quote-bg'>
      <p class='quote'>We help <span class='pink'>you</span> teach <span class='pink'>them</span></p>
    </div>
  </div>
  <div id='waves'>
    <div class='wave' id='wave1' style='background-image: url("../assets/images/wave1-shadow.png");'></div>
    <div class='wave' id='wave2' style='background-image: url("../assets/images/wave2-shadow.png");'></div>
    <div class='wave' id='wave3' style='background-image: url("../assets/images/wave3-shadow.png");'></div>
  </div>
  <section id='about'>
